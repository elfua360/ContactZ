...
//   $add = json_decode($add, true);
 ...
 //   $UID = $inData["UID"];
   ...
   /* if (isset($_SESSION['id']))
    ...
    {
        $sql = "SELECT * FROM contacts where id='" . id . "' and firstname='" . $firstname . "' and lastname='" . $lastname . "' and number='" . $number . "' and userid=" . $uid;
        echo $sql;
        echo '\n';
        ...
        if ($result->num_rows > 0)
        {
            ...
            $sql = "DELETE FROM Contacts Where id='" . id . "' and userid=" . $uid;
            $result = $conn->query($sql);
